...
class Ratings
{
    ...
    public static function CalculateRanking(score:Int,scoreDef:Int,nps:Int,maxNPS:Int,accuracy:Float):String
    {
        return
         ...
         (!PlayStateChangeables.botPlay || PlayState.loadRep ? Localizations.scoreTxt + (Conductor.safeFrames != 10 ? score + " (" + scoreDef + ")" : "" + score) + 		// Score
         (FlxG.save.data.accuracyDisplay ?																				// Accuracy Toggle
         " | "
        + Localizations.missedTxt 
        + PlayState.misses + 																				// 	Misses/Combo Breaks
         " | "
        + Localizations.accTxt
         + (PlayStateChangeables.botPlay && !PlayState.loadRep ? "N/A" : HelperFunctions.truncateFloat(accuracy, 2) + " %") +  				// 	Accuracy
