...
class ResultsScreen extends FlxSubState
{
	...
	{	
        ...
        text = new FlxText(20,-55,0,Localizations.songCleared);
        text.size = 34;
        ...
        settingsText = new FlxText(20,FlxG.height + 50,0,'SF: ${PlayState.rep.replay.sf} | Ratio (SA/GA): ${Math.round(sicks)}:1 ${Math.round(goods)}:1 | Mean: ${mean}ms | Played ${PlayState.SONG.song} on ${CoolUtil.difficultyFromInt(PlayState.storyDifficulty).toUpperCase()}');
	...
	override function update(elapsed:Float)
	{
        ...
        {            
            ...
            if (PlayState.isStoryMode)
            {
                ...
                switch (FlxG.save.data.lastSong)
                {
                    default:
