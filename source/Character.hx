...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		{
			case 'stock':
				var tex = Paths.getSparrowAtlas('stock_man','shared',true);
				frames = tex;
				...
				animation.addByPrefix('shoot', 'BF HEY', 24, false);
				animation.addByPrefix('hurt', 'BF hit', 24, false);
				animation.addByPrefix('hurt loop', 'BF hit loop', 24, false);
			...
			case 'slenderman':
				...
				tex = Paths.getSparrowAtlas('slender_assets', 'shared', true);
				frames = tex;
			...
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('normal_GF_assets','shared',true);
				frames = tex;
			...
			case 'bf':
				var tex = Paths.getSparrowAtlas('BOYFRIEND-scare','shared',true);
				frames = tex;
